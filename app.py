...
with open('one_hotencoder_geo.pkl','rb') as file:
...
geography=st.selectbox('Geography',one_hotencoder_geo.categories_[0])
...
geo_encoded=one_hotencoder_geo.transform([[geography]]).toarray()
